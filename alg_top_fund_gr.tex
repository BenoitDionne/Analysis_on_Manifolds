...
\end{cases}
\]
Then $\tilde{H}(0,s) = \beta^{-1}(0) = x_1$ and
...
\end{align*}
for $0\leq t \leq 1$.
Thus $\beta^{-1} \sigma_0 \beta \dotsim \beta^{-1}\sigma_1 \beta$.
...
$Z = \{ \VEC{y} \in Y : \alpha(y) = \beta(y) \} = h^{-1}(D)$ is closed.
...
\end{cases}
\]
for $y \in Y$.  Since $W_{\alpha_k}$ is connected, we have
that
\[
...
$1\leq m \leq 2$.  We also have that
\[
