...
manifold $S$ of class $\DS C^\infty$ for which
there exists a map
$\DS \tau: S \to \bigcup_{\VEC{u}\in S} \T^2(\TS_{\VEC{u}} S)$
of class $\DS C^\infty$ such that
...
is of class $\DS C^\infty$ for all smooth vector fields
$F_1$ and $F_2$ on $S$.

It follows from Proposition~\ref{propEIPonS} that it is always
possible to define a Riemannian metric on a manifold of $\DS \RR^n$.
...
$\DS \RR^3$
inherits the Riemannian metric of $\DS \RR^3$.  Namely,
$\ps{ (\VEC{u},\VEC{x}_1)}{(\VEC{u},\VEC{x}_2)}_{\VEC{u}}
...
We also have that $\DS \torus{2} \cong S^1 \times S^1 \subset \RR^4$.
Thus we may define a Riemannian metric on $\torus{2}$ based on the
Riemannian metric on $\DS S^1$.  If
$\DS \tau^\circ:S^1 \to
\bigcup_{\VEC{u} \in S^1} \T^2(\TS_{\VEC{u}} S^1)$
is a Riemannian metric on $\DS S^1$ and
$\DS \ps{}{}^\circ_{\VEC{u}} = \tau^\circ(\VEC{u})$ for all
$\DS \VEC{u} \in S^1$, then we can define the
Riemannian metric
$\DS \tau :S^1 \times S^1 \to
\bigcup_{(\VEC{u}_1,\VEC{u}_2) \in S^1 \times S^1}
\T^2\big(\TS_{(\VEC{u}_1,\VEC{u}_2)}\, (S^1 \times S^1)\big)$
on $\DS \torus{2} \cong S^1 \times S^1$ as it follows.
We set
$\tau(\VEC{u}_1,\VEC{u}_2) = \ps{}{}_{(\VEC{u}_1,\VEC{u}_2)}$
for all $\DS (\VEC{u}_1,\VEC{u}_2) \in S^1 \times S^1$ where
\begin{align*}
...
\end{align*}
for $\DS (\VEC{u}_i,\VEC{x}_{i,j}) \in \TS_{\VEC{u}_i} S^1$
with $1 \leq i,j \leq 2$.  These two metrics are not equivalent because
$\DS S^1 \times S^1$ with its Riemannian metric cannot be
imbedded as a submanifold of $\DS \RR^3$.  The proof is
based on the fact that the ``curvature'' of $\DS S^1 \times S^1$
...
$\DS \|\cdot\|_{\VEC{u}} = \ps{}{}_{\VEC{u}}^{1/2}$.

For $\VEC{u} \in S$, we define the action of the group of rotations
$\DS S^1$ on $\TS_{\VEC{u}}S$ as it follows.  Given
$\DS \eta = e^{i\theta} \in S^1 = \{ z \in \CC : |z|=1 \}$ and
...
chart of $\TS S$ where $\DS \tilde{W} = \TS\, W = W \times \RR^2$,
$\DS \tilde{U} = \TS\, U = \bigcup_{\VEC{u} \in U} \TS_{\VEC{u}} S$,
...
We consider a local chart of $\DS \TS S \times S^1$ 
of the form
$\big(\tilde{W} \times I,\tilde{U} \times C,(\tilde{\phi},\psi)\big)$
where $I \subset \RR$ is an open interval of length less than $2 \pi$,
the function $\DS \psi:\RR \to S^1$ is defined by
$\DS \psi(\theta) = e^{i \theta}$ for $\theta \in \RR$,
and $C = \psi(I)$.
...
Do not forget that $\DS \diff \phi(\VEC{w}) : \RR^2 \to \RR^3$
...
$\DS \VEC{q}_i(\VEC{w}) = \|\VEC{p}_i(\VEC{w})\|_{\phi(\VEC{w})}^{-1}
\VEC{q}_i(\VEC{w})$
for $i=1,2$.  We have that $\B$ is orthonormal basis
for $\TS_{\phi(\VEC{w})}S$.
If $\DS Q(\VEC{w}) = [\Id]_{\B}^{\A}$ is the matrix of
...
on the geometric aspect of the action of $\DS \eta \in S^1$ on
...
Then $\DS [\VEC{x}]_\B = \begin{pmatrix} a_1 \\ a_2 \end{pmatrix}$.
...
\end{equation}
where $\DS \upsilon = e^{i\pi/2} = i$.  Note that this
...
$\DS \breve{W} = (W \times \RR^2) \times (\RR^2 \times \RR^2)$,
$\DS \breve{U} = \TS\, \tilde{U}
...
If $\DS \pi:W \times \RR^2 \to \RR^2$ is the projection
defined by $\pi(\VEC{w},\VEC{y}) = \VEC{w}$ for all
$\DS (\VEC{w},\VEC{y}) \in W \times \RR^2$, then
...
$\DS \eta \in S^1$ acting on $\TS\, S_1$ and $\TS\, S_2$.
\end{enumerate}
\end{prop}
...
Let $\DS \eta \in S^1$ be the angle
...
There exists $\DS \mu \in S^1$ such that
...
by $\DS S_c = \bigcup_{\VEC{u} \in S} S_c(\VEC{u})$, where
...
Since
$\DS \diff_{\VEC{w},\VEC{y}} \phi^\ast(g)(\VEC{w},\VEC{y})$
is of rank $1$ for all
$\DS (\VEC{w},\VEC{y}) \in W \times \RR^2$ such that
$\DS \phi^\ast(g)(\VEC{w},\VEC{y}) = 1$, We get from
Theorem~\ref{thmIFTmanif} that
$\DS (\phi^\ast(g))^{-1}(\{1\})$ is a
$3$-dimensional manifold in $\DS W \times \RR^2$.

If $(\tilde{W},\tilde{U},\tilde{\phi})$ is a local
chart of $\DS (\phi^\ast(g))^{-1}(\{1\}) \subset W \times \RR^2$,
then $(\tilde{W},\phi_\ast(\tilde{U}), \phi_\ast \circ \tilde{\phi})$ is
local chart of $\DS S_c = g^{-1}(\{1\})$.
\end{proof}
...
$\DS E:W \to \bigcup_{\VEC{w} \in W} \diff \phi(\VEC{w}) (\RR^2)$
by
\[
...
$\DS S_c(U) = \bigcup_{\VEC{u} \in U} S_c(\VEC{u})
\cong W \times S^1$.  To prove this statement,
we define the mapping $\DS g:W \times S^1 \to S_c(U)$ by
$g(\VEC{w}, \eta) = \eta\big(\phi(\VEC{w}),E(\VEC{w})\big)$
for $\VEC{w} \in W$ and $\DS \eta \in S^1$.
The map $g$ is an isomorphism between $\DS W\times S^1$ and
$S_c(U)$.
...
\]
for $\VEC{u} \in U$ and $\DS \eta \in S^1$
defines an isomorphism between $\DS U \times S^1$ and $S_c(U)$.

However, it is generally false that $\DS S_c \cong S \times S^1$.
For instance, we cannot have $\DS S_c \cong S \times S^1$
for $\DS S = S^2$ because the isomorphism implies the
...
$\DS \breve{W} = (W \times I) \times (\RR^2 \times \RR)$
...
\end{split}
\end{equation}
where $\DS \tilde{E}(\VEC{u}) = E(\phi^{-1}(\VEC{u})) = E(\VEC{w})$.
...
$\DS \pdydx{}{\theta}\Big|_{(\VEC{w},\theta)}$
...
$\DS \rho_1'(0), \rho_2'(0) \in \RR^2$ are linearly
...
\end{align*}
for some $\DS \VEC{q}_i \in \RR^n$ \footnote{We do not need
...
$\DS \diff \phi(\VEC{w}) \rho_1'(0), \diff \phi(\VEC{w})
...
$\DS \RR^n$ centred at the origin where $\theta$ represents
the arc length.
\end{rmk}
...
for all $(\VEC{u},\VEC{x}) \in S_c$ and $\DS \eta \in S^1$.
\item $\eta_\ast$ is invertible and
$\DS (\eta_\ast)^{-1} = (\eta^{-1})_\ast$
for all $\DS \eta \in S^1$.
\end{enumerate}
\end{prop}
...
Suppose that $\DS \eta = e^{i\mu}$ for $\mu \in \RR$.
...
$\DS \eta^{-1}:S_c \to  S_c$, we
have that $\eta_\ast: \TS\,S_c \to \TS\,S_c$ and
$\DS (\eta^{-1})_\ast: \TS\,S_c \to \TS\,S_c$.  Moreover, since
$\DS \eta \circ \eta^{-1} = \Id_{S_c}$ and
$\DS \eta^{-1} \circ \eta = \Id_{S_c}$, we have that
$\DS \eta_\ast \circ (\eta^{-1})_\ast = (\eta \circ \eta^{-1})_\ast
= (\Id_{S_c})_\ast = \Id_{\TS\,S_c}$ and
$\DS (\eta^{-1})_\ast \circ \eta_\ast = (\eta^{-1} \circ \eta)_\ast
...
where $\DS \tilde{E}(\VEC{u}) = E(\phi^{-1}(\VEC{u}))$ for all
...
\]
for all $\DS \mu \in S^1$.
If $\DS \nu = e^{i \alpha}$ and $\DS \mu = e^{i \beta}$,
...
Hence $\DS \pdydx{\tilde{g}}{\beta}(\VEC{w},\beta) = (\VEC{0},1)$
for all $\beta \in \RR$.
It then follows from (\ref{HpisAstEq}) that
\begin{align*}
...
$\DS \RR^n$ implies.  The direction of the vector does
...
vectors in $S_c$.  In the figure $\DS \eta = e^{i\theta} \in S^1$.
...
Therefore
$\DS P_{(\VEC{u},\VEC{x})}$ is the $1$-dimensional subspace of
...
projected the subspaces $\DS \TS_{\VEC{u}}S$,
$\DS M_{(\VEC{u},\VEC{x})}$ and
$P_{(\VEC{u},\VEC{x})}$ into $\DS \RR^n$.  We also have
projected $H(\VEC{u},\VEC{x})$ into $\DS \RR^n$.  Normally,
...
$\eta :S_c \to S_c$ for all fixed $\DS \eta \in S^1$.
...
by an angle $\DS \eta \in S^1$.}{ParTranslFour}
...
$\MM_c = \DS \{ M_{(\VEC{u},\VEC{x})}\}_{(\VEC{u},\VEC{x})
\in S_c} \}$
...
\begin{proof}
Every element $\DS \big((\VEC{u},\VEC{x}), (\VEC{p},\VEC{q})\big)
...
$M_{(\VEC{u},\VEC{x})}$ for all $(\VEC{u},\VEC{x}) \in \tilde{U}$.
Since
$\DS \TS_{(\VEC{u},\VEC{x})} S_c = M_{(\VEC{u},\VEC{x})} \oplus
...
$\DS \big((\VEC{u},\VEC{x}), (\VEC{p},\VEC{q})\big) \in
...
for $\DS \eta \in S^1$, where
$\DS \tilde{E}(\VEC{u}) = E(\phi^{-1}(\VEC{u}))$ for all
$\VEC{u} \in U$.

We consider
$\DS S^1 \cong \{ e^{i\theta} \in \CC : \theta \in \RR \}$.
We have that
$\DS \TS_{\eta} S^1 = \{ (\eta, t\, i \eta) : t \in \RR \}$
for all $\DS \eta = e^{i\theta} \in S^1$.
We define a differential $1$-form $\omega$ on
$\DS S^1$ by $\omega(\eta)(\eta, t\, i\eta) = t$
for all $\DS \eta \in S^1$ and $t \in \RR$.

We now prove that the connection $1$-form $\check{\rho}$ associated to
$\check{\MM}_c$ is given by
$\DS \check{\rho} = (G^{-1})^\ast(\pi_2^\ast(\omega))$ where
$\DS \pi_2: U \times S^1 \to S^1$ is the
projection defined by $\pi_2(\VEC{u},\eta) = \eta$ for all
$\DS (\VEC{u},\eta) \in U \times S^1$, and $G$ is the
function defined in Remark~\ref{rmkUS1eScU}.
Since $\DS G:U \times S^1 \to S_c(U)$ is an isomorphism, we
have that $\DS G_\ast:\TS\,(U\times S^1) \to \TS\, S_c(U)$ is an
isomorphism.  Therefore, given
$\big(\eta(\VEC{u},\tilde{E}(\VEC{u})),(\VEC{p},\VEC{q})\big)
\in \TS_{\eta(\VEC{u}, \tilde{E}(\VEC{u}))} S_c$ with
$\DS \eta = e^{i\theta}$, there exists
$\DS \big((\VEC{u},\eta),(\VEC{r},t\, i\eta)\big)
...
that $\DS \pdfdx{G_{\VEC{u}}(\eta)}{\eta}
= \pdfdx{G(\VEC{u},\eta)}{\eta}$ for $\VEC{u}$ constant is defined
with the help of the local coordinate $\DS \eta = e^{i\theta}$ as
\[
...
(\eta,t\, i\eta)$ for all\\
$\DS \big((\VEC{u}, \eta),(\VEC{r},t\, i \eta)\big) \in
...
$\DS \MM_c = \{ M_{(\VEC{u},\VEC{x})}\}_{(\VEC{u},\VEC{x})}$,
...
Let $S$ be a $2$-dimensional Riemannian manifold and
$\MM_c = \DS \{ M_{(\VEC{u},\VEC{x})}\}_{(\VEC{u},\VEC{x})\in S_c} \}$
be a connection on $S_c$ where $\rho$ is the connection $1$-form
associated to $\MM_c$.  Then
$\DS \eta^\ast(\rho)(\VEC{u},\VEC{x}) = \rho(\VEC{u},\VEC{x})$
for all $\DS \eta\in S^1$ and $(\VEC{u},\VEC{x})\in S_c$.
\end{prop}
...
$\DS \big((\VEC{u},\VEC{x}), (\VEC{p},\VEC{q})\big)
...
$(\VEC{u},\VEC{x}) \in S_c$ and $\DS \eta^\ast(\rho) = \rho$ for all
$\DS \eta \in S^1$.  Them
$\DS \MM_c = \{ M_{(\VEC{u},\VEC{x})}
\}_{(\VEC{u},\VEC{x})\in S_c}$ with
$\DS M_{(\VEC{u},\VEC{x})} = (\rho(\VEC{u},\VEC{x}))^{-1}
...
Since $\DS \eta^\ast(\rho) = \rho$, we get
\[
\rho(\eta(\VEC{u},\VEC{x}))
...
$\DS \xi(\VEC{u},\VEC{x})\big(H(\VEC{u},\VEC{x})\big) = 0$
for all $(\VEC{u},\VEC{x}) \in S_c$ and $\DS \eta^\ast(\xi) = \xi$
for all $\DS \eta \in S^1$.
Then $\DS \xi = \pi_S^\ast(\omega)$ for
...
$\eta_\ast$ is invertible and $\DS (\eta_\ast)^{-1} = (\eta^{-1})_\ast$
for all $\DS \eta \in S^1$.  Hence, given
...
\end{align*}
where we may assume that $\DS \psi,t \in S^1$ are constant.
Thus $\DS \phi^\ast(\omega)$ is a smooth differential form on
...
$\DS \omega(\VEC{u})(\VEC{u},\VEC{x})
= \xi(\VEC{u},\VEC{p})
\big( (\VEC{u},\VEC{p}),( \VEC{x}, \VEC{q})\big)$
with
$\tilde{x} = \psi.\tilde{E}(\VEC{u})$ and
$\DS \VEC{q} = \diff_{\VEC{w},\psi} (\psi.E(\VEC{w}))
...
Suppose that $\DS \MM_c^{[i]} = \{ M^{[i]}_{(\VEC{u},\VEC{x})}
\}_{(\VEC{u},\VEC{x})\in S_c}$ for $i =1,2$ are 
two connections on $S_c$ and $\DS \rho^{[i]}$ is a connection
$1$-form associated to $\DS \MM_c^{[i]}$ for $i = 1,2$.
Then $\DS \rho^{[1]}-\rho^{[2]} = \pi_S^\ast(\omega)$ for
some smooth differential $1$-form $\omega$ on $S$.
\end{cor}
...
$\DS \rho^{[i]}(\VEC{u},\VEC{x})\big(H(\VEC{u},\VEC{x})\big) =1$
for all $(\VEC{u},\VEC{x}) \in S_c$ and 
$\DS \eta^\ast\big(\rho^{[i]}\big)= \rho^{[i]}$ for all
$\DS \eta \in S^1$ and $i =1,2$.  Hence, if we
set $\DS \xi = \rho^{[1]} - \rho^{[2]}$, then we get that
$\DS \xi(\VEC{u},\VEC{x})\big(H(\VEC{u},\VEC{x})\big) = 0$
for all $(\VEC{u},\VEC{x}) \in S_c$ and $\DS \eta^\ast(\xi) = \xi$
for all $\DS \eta \in S^1$.  The conclusion of the corollary 
...
Suppose that
\begin{enumerate}
\item $\DS \sigma:[a,b] \to S$ is a smooth curve,
\item $\DS \tilde{\sigma}^{[i]}:[a,b] \to S_c$ is smooth
curves such that $\DS \pi_S \circ \tilde{\sigma}^{[i]} = \sigma$
for $i =1,2$, and
\item $\DS \rho\big(\tilde{\sigma}^{[1]}(t))\big)
\big( (\tilde{\sigma}^{[1]})_\ast(t,1) \big) = 0$
for $a \leq t \leq b$.
\end{enumerate}
Then there exists a smooth function $\theta:[a,b] \to \RR$ such that
$\DS \tilde{\sigma}^{[2]}(t) = \eta_t(\tilde{\sigma}^{[1]}(t))$ with
$\DS \eta_t = e^{i\theta(t)} \in S^1$ and
$\DS \rho\big(\tilde{\sigma}^{[2]}(t))\big)
\big( (\tilde{\sigma}^{[2]})_\ast(t,1) \big) = \theta'(t)$
for $a \leq t \leq b$.

Moreover, if
$\DS \tilde{\sigma}^{[1]}(a) = \tilde{\sigma}^{[2]}(a)$, then
we can choose $\theta$ such that $\theta(a) = 0$.
\end{prop}

\begin{proof}
\stage{i} Since $\DS \pi_S(\tilde{\sigma}^{[i]}(t)) = \sigma(t)$ for
$a \leq t \leq b$ and $i =1,2$, we have that
$\DS \tilde{\sigma}^{[i]}(t) \in \TS_{\sigma(t)} S_c$ for
$a \leq t \leq b$ and $i =1,2$.  Thus, for each $t \in [a,b]$,
there exists $\DS \eta_t \in S^1$ such that
$\DS \tilde{\sigma}^{[2]}(t) = \eta_t(\tilde{\sigma}^{[1]}(t))$.
Since $\DS \tilde{\sigma}^{[i]}$ for $i =1,2$ are
smooth functions, we have that $\DS \eta:[a,b] \to S^1$
defined by
$\eta(t)= \eta_t$ for $a \leq t \leq b$ is also smooth.

Let $\theta:[a,b] \to \RR$ be a function such that
$\DS e^{i \theta(t)} = \eta(t)$.  Since $\eta$ is smooth and
$[a,b]$ is connected, we get that $\DS \eta([a,b]) \subset S^1$ is
...
$\DS (\RR,e^{i\theta})$ is a covering of $\DS S^1$
(Figure~\ref{FundGr2}).

If $\DS \tilde{\sigma}^{[1]}(a) = \tilde{\sigma}^{[2]}(a)$,
...
Let $\DS \mu^{[i]}:[c,d] \to \tilde{W}$ be the local
representation of $\DS \tilde{\sigma}^{[i]}$ for $i =1,2$;
namely, $\DS \tilde{\sigma}^{[i]} = \tilde{\phi} \circ \mu^{[i]}$  on
$[c,d]$ for $i =1,2$.  We have for $i=1,2$ that
$\DS \mu^{[i]}(t) = (\mu(t), \psi^{[i]}(t))$ for some
$\DS \psi^{[i]}(t) \in \RR$.
Moreover,
\[
...
$\DS (\eta_s)_\ast \left( \tilde{\sigma}^{[1]}_\ast(t,1) \right)
...
\begin{pmatrix} \mu'(t) \\ \DS \dydx{\psi^{[1]}}{t}(t) \end{pmatrix}
\right) \ .
\end{align*}
Hence, at $t=s$, we get
\begin{align*}
...
be a connection on $S_c$ where $\rho$ is a connection $1$-form
associated to $\MM_c$.
Suppose that $\DS \sigma:[a,b] \to S$ a piecewise
$\DS C^\infty$ curve \footnotemark\ and that
$(\sigma(a),\VEC{x}) \in S_c$.
Then there exists a unique piecewise $\DS C^\infty$
...
\footnotetext{Recall that a piecewise $\DS C^\infty$ function 
$\DS f:[a,b] \to \RR^n$ is a continuous function which is of class
$\DS C^\infty$ on all the closed intervals delimited by the
...
sections of a piecewise $\DS C^\infty$ curve using the
...
$\DS G: U \times S^1 \to S_c(U) = \bigcup_{\VEC{u} \in U} S_c(\VEC{u})$
defined by
$G(\VEC{u},\eta) = \big(\VEC{u},\theta.\tilde{E}(\VEC{u})\big)$
for $\VEC{u} \in U$ and $\DS \eta = e^{i\theta} \in S^1$
...
for $\VEC{u} \in U$ and $\DS \eta \in S^1$ by definition, we
...
$\DS \check{\rho} - \rho = \pi_S^\ast{(\omega)}$.  Choose a curve
$\tilde{\sigma}:[a,c]\to S_c(U)$ such that
$\pi_S(\tilde{\sigma}(t)) = \sigma(t)$ for $a \leq t \leq c$.
It follows from Proposition~\ref{proUnHorLift} that there exists
a smooth function $\xi:[a,c] \to \RR$ such that
$\DS \tilde{\sigma}(t) = \eta_t(\check{\sigma}(t))$ with
$\DS \eta_t = e^{i\xi(t)} \in S^1$ and
$\DS \check{\rho}\big(\tilde{\sigma}(t))\big)
...
$\DS \xi(t) = \int_a^t \omega(\sigma(s))\big(\sigma_\ast(s,1)\big)
...
There exists $\DS \eta \in S^1$ such that 
...
smooth manifold and
the inner product $\ps{}{}_{\VEC{u}}$ on $\DS \TS_{\VEC{u}} S$
...
is a basis of $\DS \Omega^1\left(\TS_{(\VEC{u},\VEC{x})} S_c\right)$
for all $(\VEC{u},\VEC{x}) \in S_c$.
\end{prop}

\begin{proof}
Since $\DS \Omega^1\left(\TS_{(\VEC{u},\VEC{x})} S_c\right)$
is the dual space of $\TS_{(\VEC{u},\VEC{x})} S_c$, we have that
$\DS \dim \Omega^1\left(\TS_{(\VEC{u},\VEC{x})} S_c\right) = 3$.
...
Moreover,
$\DS \eta^\ast(\omega_1 \wedge \omega_2) = \omega_1 \wedge \omega_2$.
\end{prop}
...
$\DS \omega_1 \wedge \omega_2 = (\pi_S)^\ast(\omega)$.
\end{prop}
...
$\DS (\pi_S)^\ast(\omega) = \omega_1 \wedge \omega_2$.
\end{proof}
...
$\DS (\pi_S)^\ast(\dx{V}) = \omega_1 \wedge \omega_2$.
\end{defn}
...
$\DS (\tilde{\phi}^{-1} \circ g \circ \phi)(\VEC{w}) =
(\VEC{w},0)$ and
$\DS (\tilde{\phi}^{-1} \circ (\upsilon\circ g) \circ \phi)
...
Similarly,
$\DS g^\ast(\omega_2)(\VEC{u})\big(\VEC{u},\VEC{x}\big)
= \tilde{\omega}_2(\VEC{u},\VEC{x})$
for all $(\VEC{u},\VEC{x}) \in \TS_{\VEC{u}} S$.  Thus
$\DS \tilde{\omega}_i = g^\ast(\omega_i)$ for $i=1,2$.
It follows that
\begin{align}
...
Let $\DS \rho_i = (\pi_S)^\ast(\tilde{\omega}_i)$ for
...
Moreover, given $\DS \eta = e^{i\theta} \in S^1$, we have
\[
...
$\DS \Omega^1\left(\TS_{(\VEC{u},\VEC{x})} S_c\right)$
...
$\DS \df{\rho_i} = \df{\big((\pi_S)^\ast(\tilde{\omega}_i)\big)}
...
\]
for $i =1,2$.
If we compute the differential of (\ref{O1cP1psP2Eq2}), then we get
\begin{align}
...
$\DS \tilde{\phi}^\ast(\tilde{\theta}) : W \times I \to \RR$
is defined by
$\DS \tilde{\phi}^\ast(\tilde{\theta})(\VEC{w},\theta) = \theta$.
Hence
$\DS \df{\big(\tilde{\phi}^\ast(\tilde{\theta})\big)}
...
$\DS (G^{-1}\circ \tilde{\phi})(\VEC{w},\theta) = (\VEC{u}, \eta)$
for $\DS \eta = e^{i\theta}$ and
$\DS (G^{-1} \circ \tilde{\phi})_\ast
...
$\DS \check{\rho} - \rho = \pi_S^\ast(\omega)$.  Since
$\{ \tilde{\omega}_1(\VEC{u}), \tilde{\omega}_2(\VEC{u}) \}$ is
a basis of $\DS \Omega^1\big(\TS_{\VEC{u}} S\big)$
...
basis of $\DS \Omega^1\big(\TS_{(\VEC{u},\VEC{x})} S_c\big)$
...
(\ref{FirstStructEq2}) and (\ref{FirstStructEq3}), then we get
\begin{align*}
...
we consider the connection $\DS \check{\MM}_c
= \{ \check{M}_{(\VEC{u},\VEC{x})}\}_{(\VEC{u},\VEC{x}) \in S_c(U)}$
on $S_c(U)$ with its associated connection $1$-from $\check{\rho}$
defined in Examples~\ref{eggConnPAp1} and \ref{eggConnPAp2}.
According to Corollary~\ref{cor2rho2do}, there exists a
differential $1$-form $\omega$ on $U$ such that
$\DS \check{\rho} - \rho = (\pi_S)^\ast(\omega)$.
...
in particular
$\DS \tilde{\phi}(\VEC{u},\theta) = e^{i\theta}(\VEC{u},\VEC{e}_1)
= (\VEC{u},\theta.\VEC{e}_1)$ because $\DS W = U = S$, we
...
\end{align*}
where $\DS \VEC{r} \in \RR^2$ is such that
...
$\DS \rho_i = (\pi_S)^\ast(\tilde{\omega}_i)$ for $i=1,2$, and
...
$\DS \df{\theta}\Big(\pdydx{}{\theta}\Big) =
\pdydx{\theta}{\theta} = 1$ and
$\DS \df{\theta}\Big(\pdydx{}{w_i}\Big) =
...
$\DS \sigma:[a,b]\to S \subset \RR^3$ is a smooth curve
...
If we derive $\DS \|\sigma'(t)\|^2=1$ with respect to $t$, then
...
$\DS H(\sigma(t),\sigma'(t))$ is $\|\sigma''(t) \|^{-1} \,
\sigma''(t)$; namely, 
\[
H(\sigma(t),\sigma'(t))
...
Then $\DS \frac{1}{2\pi} \int_S \kappa \dx{V} = \Chi(K)$
...
\begin{enumerate}
\item $V$ is an open set such that $\DS [s] \subset V \subset \RR^2$,
\item $h:V \to S$ is a smooth, non-singular \footnotemark, and orientation
preserving function,
\item $\DS \sigma:[a,b] \to S$ is a parametric representation of
the piecewise $\DS C^\infty$ closed curve
...
$\DS \eta = e^{i \theta} \in S^1$ with
$\DS \theta = -\int_{h([s])} \kappa \dx{V}$.
\end{prop}
...
$\DS \int_{\osscript{\VEC{x}_{i_0}}{}{}{}{\VEC{x}_{i_1}}} = 
...
representation $\DS \sigma:[0,3] \to S$ of
...
where $\DS (t,r) \mapsto \eta_{t,r} \in S^1$ is smooth
...
$\DS \rho(\tilde{\tau}(t)) \big(\tilde{\tau}_\ast(t,1)\big) = 0$
...
$\DS \eta_t = e^{i\theta(t)} \in S^1$ for $2\leq t \leq 3$, and
...
finite number of values of $t$, then we can define the arc length function
$s:[a,b] \to [0,L]$ by defining it on each of the intervals where
$\sigma'(t) \neq \VEC{0}$ and summing them.  As usual, the piecewise
$\DS C^\infty$ parametric representation by arc length
is given by
$\DS \breve{\sigma} = \sigma \circ s^{-1}:[0,L]\to [a,b]$.}. 
We set
\[
...
piecewise $\DS C^\infty$ curves on $S$.  If
\[
\sigma(t) =
\begin{cases}
...
\end{cases}
\]
for some $c \in\, ]a,b[$, and piecewise $\DS C^\infty$ curves
...
\item $\DS \sigma^{\osscript{s}{}{}{}{}}:[a,b] \to S$ is a parametric
representation of the piecewise $\DS C^\infty$ closed curve
$h(\partial\, [s])$ such that the orientation on
$\DS \sigma^{\osscript{s}{}{}{}{}}$ is the orientation
on $h(\partial\,[s])$ induces via $h$ by $\partial_2 \os{s}{}{}{}{}$, and
\item $t_0 = a < t_1 < t_2 < t_3 = b$ are such that
$\DS \sigma^{\osscript{s}{}{}{}{}}$ is of class
$\DS C^\infty$ on $[t_j,t_{j+1}]$ for $0 \leq j < 3$.
\end{enumerate}
Let
\begin{enumerate}
\item $\DS \sigma_j^{\osscript{s}{}{}{}{}}
= \sigma^{\osscript{s}{}{}{}{}}\big|_{[t_j,t_{j+1}]}$ for $0 \leq j < 3$.
\item $\DS \sigmaU_j^{\osscript{s}{}{}{}{}} :[t_j,t_{j+1}]
\to \TS\, S$ be the curve defined by
$\DS \sigmaU_j^{\osscript{s}{}{}{}{}}(t)
= \big(\sigma^{\osscript{s}{}{}{}{}}(t),(\sigma^{\osscript{s}{}{}{}{}})'(t)\big)$
for $t_j \leq t \leq t_{j+1}$ and $0 \leq j < 3$, and
\item $\DS \tilde{\sigma}_j^{\osscript{s}{}{}{}{}}:[t_j,t_{j+1}]$
be the horizontal lift of $\DS \sigma_j^{\osscript{s}{}{}{}{}}$
with $\DS \tilde{\sigma}_j^{\osscript{s}{}{}{}{}}(t_j)
= \tilde{\sigma}_{j-1}^{\osscript{s}{}{}{}{}}(t_j)$ for $0 < j < 3$,
and $\DS \tilde{\sigma}_0^{\osscript{s}{}{}{}{}}(t_0)
= \sigmaU_0^{\osscript{s}{}{}{}{}}(t_0)
= \big(\sigma^{\osscript{s}{}{}{}{}}(t_0),
(\sigma^{\osscript{s}{}{}{}{}})'(t_0)\big)$.
\end{enumerate}
The internal angle $\DS \mu_2^{\osscript{s}{}{}{}{}}$
and external angle $\DS \nu_2^{\osscript{s}{}{}{}{}}$ at
$\DS \sigma^{\osscript{s}{}{}{}{}}(t_2)$ are defined
in the following figure.
\pdfbox{riemann_geom/gbfig4}
We define the internal angle
$\DS \mu_1^{\osscript{s}{}{}{}{}}$ and
the external angle $\DS \nu_1^{\osscript{s}{}{}{}{}}$ at
$\DS \sigma^{\osscript{s}{}{}{}{}}(t_1)$, and the internal
angle $\DS \mu_3^{\osscript{s}{}{}{}{}}$ and the
external angle $\DS \nu_3^{\osscript{s}{}{}{}{}}$ at
$\DS \sigma^{\osscript{s}{}{}{}{}}(t_3)
= \sigma^{\osscript{s}{}{}{}{}}(t_0)$, in a similar fashion.  An attention
particular should be given to the directions of the angles at the
vertex $\DS \sigma^{\osscript{s}{}{}{}{}}(t_2)$
indicated by the directed arcs.  All the blue vectors drawn from
$\DS \sigma^{\osscript{s}{}{}{}{}}(t_2)$ are in fact in
$\DS \TS_{\sigma^{\osscript{s}{}{}{}{}}(t_2)} S$ because all
the edges are in $S$.  As well,
$\DS \tilde{\sigma}_1^{\osscript{s}{}{}{}{}}(t_2)
...
\item $\DS \sigma^{\osscript{s}{}{}{}{}}:[a,b] \to S$ is a
parametric representation of the piecewise $\DS C^\infty$
closed curve $h(\partial\, [s])$ such that the orientation on
$\DS \sigma^{\osscript{s}{}{}{}{}}$ is the orientation on
...
\begin{proof}
We may assume that $\DS \sigma^{\osscript{s}{}{}{}{}}$ is a
parametric representation by arc length because
$\DS \tau(\sigma_{j-1}^{\osscript{s}{}{}{}{}})$ is computed
using $\DS \sigma^{\osscript{s}{}{}{}{}}$ parameterized by arc length.
Let $\DS \tilde{\sigma}^{\osscript{s}{}{}{}{}}:[a,b] \to S_c$
be the horizontal lift of $\DS \sigma^{\osscript{s}{}{}{}{}}$ with
$\DS \tilde{\sigma}^{\osscript{s}{}{}{}{}}(a)
= \sigmaU^{\osscript{s}{}{}{}{}}(a)
= \big(\sigma^{\osscript{s}{}{}{}{}}(a),
(\sigma^{\osscript{s}{}{}{}{}})'(a)\big)$.
We have from Proposition~\ref{propRotSimpl} that
$\DS \eta(\tilde{\sigma}^{\osscript{s}{}{}{}{}}(b))
= \tilde{\sigma}^{\osscript{s}{}{}{}{}}(a)$ for
$\DS \eta = e^{i \theta} \in S^1$ with
$\DS \theta = -\int_{h([s])} \kappa \dx{V}$.
We also have from Proposition~\ref{proUnHorLift} that
$\DS \sigmaU_{j-1}^{\osscript{s}{}{}{}{}}(t_j)
= \eta_j\big(\tilde{\sigma}_{j-1}^{\osscript{s}{}{}{}{}}(t_j)\big)$ with
$\DS \eta_j = e^{i\theta_{j-1}^{\osscript{s}{}{}{}{}}}$ where
\[
...
$\DS \eta^{[r]} = \eta^{[0]} + r (\eta - \eta^{[0]})$
where $\eta$ is the Riemannian metric on $S$ from the statement of
the lemma and $\DS \eta^{[0]}$ is the Riemannian metric on
$S$ induced from $\DS \RR^2$ using the function $h:V \to S$.
Basically, we treat $h(V)$ and $\sigma$ as $V$ and $\partial_2
\os{s}{}{}{}{}$ respectively.

For the Riemannian metric $\DS \eta^{[0]}$,
we have that $\kappa = 0$ on
$h(V)$ because $V$ is an open subset of $\DS \RR^2$
...
Section~\ref{sectGeodesic}, then we get that $\kappa_{\sigma}(t)=0$ for all
$t$ in the interval.}.  Hence (\ref{lemmaGBEq1}) yields
$\DS 0 = (3 - 2k)\pi  - \sum_{j=0}^3 \mu_j^{\osscript{s}{}{}{}{}}$.
Since the sum of
the internal angles for a triangle is $\pi$, we have that 
$\DS \sum_{j=0}^3 \mu_j^{\osscript{s}{}{}{}{}} = \pi$.  Thus $k = 1$.
...
$h_{[s]}:U_{[s]} \to S$ of class $\DS C^\infty$ such that
...
Suppose that $\DS \sigma_{j_1-1}^{\osscript{s_1}{}{}{}{}}$ and
$\DS \sigma_{j_2-1}^{\osscript{s_2}{}{}{}{}}$ are the parametric
representations of the common edge between the oriented $2$-simplices
$\os{s_1}{}{}{}{}$ and $\os{s_2}{}{}{}{}$.  Then
$\DS \tau(\sigma_{j_2-1}^{\osscript{s_2}{}{}{}{}}) =
...
$\DS \int_{S^2} \kappa \dx{V} = 4\pi$ without having to compute
the integral.

Suppose that $\DS (S^2,K,h)$ is a smoothly triangulated
...
$\DS H_j(S^2;\RR) \cong H_j([K];\RR)$ because
$\DS h:[K] \to S^2$ is a homeomorphism.  Therefore, we may use the
results in Example~\ref{eggHkSq} to get the Betti numbers
$\beta_j = \dim(H_j(K;\RR))$ for $0 \leq j \leq 2$ that we need to
compute the Euler characteristic
$\DS \Chi(K) = \sum_{j=0}^2 (-1)^j \beta_j$ as defined in
Definition~\ref{defnBettiEulerC}.

We have from Example~\ref{eggHkSq} that
$\DS H_0(S^2;\RR) \cong \RR$, 
$\DS H_1(S^2;\RR) \cong 0$ and
$\DS H_2(S^2;\RR) \cong \RR$.  Hence $\beta_0 = \beta_2 = 1$
and $\beta_1 = 0$.  We get that $\Chi(K) = 2$ and thus
$\DS \int_{S^2} \kappa \dx{V} = 2\pi \Chi(K) = 4\pi$.
\end{egg}

\begin{egg}
We can use the Gauss-Bonnet theorem to prove that
$\DS \int_{\torus{2}} \kappa \dx{V} = 0$ without having to compute
the integral.

As in the previous example, suppose that $\DS (\torus{2},K,h)$ is a
smoothly triangulated manifold.  We may use
$\DS H_j(\torus{2};\RR) \cong H_j(K;\RR)$ for $0 \leq j \leq 2$ to
get the Betti numbers $\beta_j = \dim(H_j(K;\RR))$ for $0 \leq j \leq 2$.
Since
$\DS H_j(\torus{2};\RR) \cong H_j(S^1;\RR) \times H_j(S^1;\RR)$
for $0 \leq j \leq 2$, we get from Example~\ref{eggHkSq} that
$\DS H_0(\torus{2};\RR) \cong \RR^2$, 
$\DS H_1(\torus{2};\RR) \cong \RR^2$ and
$\DS H_2(\torus{2};\RR) \cong 0$.  Hence $\beta_0 = \beta_1 = 2$
and $\beta_2 = 0$.  We get that $\Chi(K) = 0$ and thus
$\DS \int_{S^2} \kappa \dx{V} = 2\pi \Chi(K) = 0$.
\end{egg}

We have seen in Proposition~\ref{propNNVFodd} that there is no
nowhere null vector field on $\DS S^{k-1}$ if $k$ is odd.
...
$\DS f(\VEC{u}) = (\|F\VEC{u}\|_{\VEC{u}})^{-1} F(\VEC{u})$ where
$\|\cdot\|_{\VEC{u}}$ is the norm induced by the Riemannian metric
$\DS \tau:S \to \bigcup_{\VEC{x} \in S} \T^2(\TS_{\VEC{u}} S)$.

According to the second structural equation
$\DS \df{\rho} = - (\pi_S)^\ast(\kappa \dx{V})$ where $V$ is
...
$\DS g \in C^\infty(S)$, then
$F(g):\VEC{u} \mapsto F(\VEC{u})(g)$ for $\VEC{u} \in S$ defines a function
in $\DS C^\infty(S)$.  Therefore, the following definition
makes sense.
...
\]
for all $\VEC{u} \in S$ and $\DS g \in C^\infty(S)$.
\end{defn}
...
$\VEC{u}\in S$ is a function of class $\DS C^\infty$.
...
$\DS \phi^\ast(\omega) = \sum_{i=1}^k \omega_i \df{u_i}$
...
equations in Definition~\ref{defnFCartanEs}, then we get
...
equation in Definition~\ref{defnSecondCSE}, then we get
...
$\DS \upsilon = e^{i \pi/2} \in S^1$.  Moreover,
...
$\DS \sigma_{\VEC{u}}^\ast\left(\dydx{}{t}\Big|_t\right)
...
$\DS \tilde{F}_i(\VEC{w}) = \sum_{j=1}^k
(\tilde{f}_i)_j(\VEC{w}) \pdydx{}{w_j}\Big|_{\VEC{w}}$ for $\VEC{w} \in W$ and
$i =1,2$, where $\DS (\tilde{f}_i)_j:W \to \RR^k$ for
...
\end{align*}
for all $\DS \phi \in C^\infty(S)$.

We have that
$\DS \dfdx{\tilde{X}(t,\VEC{w})}{t} =
...
for all $\DS \tilde{g} \in C^\infty(W)$
because
\[
\tilde{X}_{\VEC{w}}^\ast\left( \dydx{}{t}\Big|_t \right)(\tilde{g}) 
...
\end{align*}
for all $\DS \tilde{g} \in C^\infty(W)$ and $|t|$ small enough.

The local representation of the vector field
$\DS Q_t = X_t^\ast(F_2)$ is given by\\
$\DS \tilde{Q}_t(\VEC{w}) = \sum_{j=1}^k (\tilde{q}_t)_j(\VEC{w})
\pdydx{}{w_j}$ where
...
$\DS Q_t = X_t^\ast(F_2)$ is given by\\
$\DS \sum_{j=1}^k (\tilde{q}_t)_j(\VEC{w})
\pdfdx{}{w_j}\Big|_{\VEC{w}=\phi^{-1}(\VEC{u})}$,
the local representation of the vector field
$\DS \dfdx{\big(X_t^\ast(F_2)\big)}{t}\Big|_{t=0}$
is given by
$\DS \sum_{i=1}^k \dfdx{\big(\tilde{q}_t(\phi^{-1}(\VEC{u}))_j\big)}{t}
...
Suppose that $\DS g \in C^\infty(S)$.  Then
\begin{align}
...
because\\
$\DS (G_1,G_2) \mapsto G_1^\ast (F_2)(\VEC{u})\,(G_2^\ast(g))$ is a
...
Let $\DS Q:[0,\epsilon_{\VEC{u}}[ \times S^1 \to S_c$ be
the function defined by
$Q(t,\eta) = X\big(t ,\eta(\VEC{u},\tilde{E}(\VEC{u}))\big)$
for $t \in [0,\epsilon_{\VEC{u}}[$ and $\DS \eta \in S^1$,
where $\DS \tilde{E}(\VEC{u}) = E(\phi^{-1}(\VEC{u}))$
...
Let $\DS P:[0,\epsilon_{\VEC{u}}[\times S^1 \to
D_{\epsilon_{\VEC{u}}} \cong B_{\epsilon_{\VEC{u}}}(\VEC{0})$
be the function defined by $P(t,\eta) = t( \theta.\VEC{e}_1)$
for $\DS (t,\eta) \in [0,\epsilon_{\VEC{u}}[\times S^1$ and
$\DS \eta = e^{i \theta}$.  Since
$\DS P\big|_{]0,\epsilon_{\VEC{u}}[\times S^1}$ is an isomorphism,
we may define
$\DS R: D_{\epsilon_{\VEC{u}}} \to [0,\epsilon_{\VEC{u}}[\times S^1$
by
\[
R(\VEC{x}) =
\begin{cases}
...
\]
We have that
$\DS \big(P\big|_{]0,\epsilon_{\VEC{u}}[\times S^1}\big)^{-1}
...
because $\pi_S(Q(0,\eta)) = \VEC{u}$ for all $\DS \eta \in S^1$.
...
We use $\DS D_{\epsilon_{\VEC{u}}} = B_{\epsilon_{\VEC{u}}}(\VEC{0})
\subset \RR^2$ and show that
$\DS \diff G(\VEC{0}) : \RR^2 \to \TS_{\VEC{u}} S$
...
$\DS \VEC{x} = \theta.\VEC{e}_1 \in \RR^2$ with
$0 \leq \theta < 2\pi$ fixed and let
$\DS \eta = e^{i\theta} \in S^1$.  We get the directional
derivative
\begin{align*}
...
Since $\DS \eta \in S^1$ is arbitrary, all the directions
...
\end{align*}
where $\DS \upsilon = e^{i(\pi/2)}$ as usual.
...
$V_2$ on $\DS ]0,\epsilon_{\VEC{u}}[\times S^1$ can also
...
\end{equation}
for $\DS (t,\eta) \in ]0,\epsilon_{\VEC{u}}[\times S^1$.
...
$\DS ]0,\epsilon_{\VEC{u}}[\times S^1$.
\item $[V_1,V_2](t,\eta) = \big((t,\eta), (0,0) \big)$
for all $\DS (t,\eta) \in ]0,\epsilon_{\VEC{u}}[\times S^1$.  
...
$\DS ]0,\epsilon_{\VEC{u}}[\times S^1$ as defined above, we get for
...
\]
where $\DS Y: ]-\epsilon,\epsilon[ \times
...
$\DS \check{Y}: ]-\epsilon_{(r,\theta)},\epsilon_{(r,\theta)}[
...
representation of the vector field $\DS Q_s = Y_s^\ast(V_2)$.
Let $\DS \check{v}_2 :\check{W} \to \RR^2$ be the function
associated to the local representation $\check{V}_2$ of $V_2$ given in
(\ref{defnV1V2rt}); namely, $\DS \check{v}_2 =
\begin{pmatrix} 0 & 1 \end{pmatrix}^\top$.

The local representation of the vector field
$\DS Q_s = Y_s^\ast(V_2)$ is
$\DS \tilde{Q}_s(r,\theta) = (\tilde{q}_s)_1(r,\theta)
...
$\DS Y_s^\ast(V_2)$ is
$\DS \pdydx{}{\theta}\Big|_{(r,\theta) = \check{\phi}^{-1}(t,\eta)}$.
...
\VEC{e}_1\big)$ for $\DS \eta= e^{i\theta}$,
$\DS \upsilon = e^{i(\pi/2)}$ and $p,q \in \RR$.
Note that $\DS \big( (r,\eta), (p,q\,\upsilon\,\eta))\big)
\in \TS_{(t,\eta)}\, ]0,\epsilon_{\VEC{u}}[\times S^1$.
\end{lemma}

\begin{proof}
We consider a local chart $(\check{W},\check{U},\check{\phi})$ of
$\DS [0,\epsilon_{\VEC{u}}[ \times S^1$.  Recall that
$\DS \phi(r,\theta) = (r , e^{i\theta} )$
for $(r,\theta) \in \check{W} \subset ]0,\epsilon_{\VEC{u}}[\times \RR$.
The local representation of $P$ is given by
$\DS \tilde{P}(r,\theta) = (P\circ \phi)(r,\theta)
...
\]
or all
$\DS \big( (r,\theta) , (p,q)\big) \in \TS_{(r,\theta)} \check{W}$.
...
\end{split}
\end{equation}
for all $\DS (t,\eta) \in ]0,\epsilon_{\VEC{u}}[\times S^1$.  However,
$\DS \df{\big(Q^\ast(\omega_1)(V_1)\big)} = 0$ because
$\DS Q^\ast(\omega_1)(V_1) = 1$ on
$\DS ]0,\epsilon_{\VEC{u}}[\times S^1$
according to the second item of Lemma~\ref{lemmaMRs2}, and
$\DS Q^\ast(\omega)(t,\eta)([V_1,V_2](t,\eta)) = 0$
for all $\DS (t,\eta) \in ]0,\epsilon_{\VEC{u}}[\times S^1$
...
for $\DS (t,\eta) \in ]0,\epsilon_{\VEC{u}}[\times S^1$.
Thus
$\DS \big(Q^\ast(\omega_1)(V_2)\big)(t,\eta)
...
$\DS t \mapsto G_\ast\big(P_\ast(V_2(t,\eta))\big)$ is
orthogonal to \\
$\DS t \mapsto G_\ast\big(P_\ast(V_1(t,\eta))\big) = Q(t,\eta) =
...
\end{align*}
because
$\DS \omega_1(Q(t,\eta))\big(Q_\ast(V_2(t,\eta))\big)
...
\end{equation}
for all
$\DS (t,\eta) \in [0,\epsilon_{\VEC{u}}[ \times S^1$,
...
for all
$\DS (t,\eta) \in [0,\epsilon_{\VEC{u}}[ \times S^1$
because $\DS Q^\ast(\omega_1)(t,\eta)(V_2(t,\eta)) = 0$ according to
Corollary~\ref{corMRs3} and
$\DS Q^\ast(\omega_1)(t,\eta)(V_1(t,\eta)) = 1$ according to
...
\label{geoCoordEq6}
\end{align}
because $\DS Q^\ast(\omega_2)(V_1)=0$ and
...
$\DS Q^\ast(\omega_2)$ but this time with
$\DS Q^\ast(\rho)$.  From the second structural equations, 
we have
\[
...
\end{align}
for all $\DS (t,\eta) \in [0,\epsilon_{\VEC{u}}[ \times S^1$
because $\DS Q^\ast(\omega_1)(t,\eta)(V_2(t,\eta)) = 0$ 
and $\DS Q^\ast(\omega_1)(t,\eta)(V_1(t,\eta)) = 1$ according to the
...
\label{geoCoordEq8}
\end{align}
because $\DS Q^\ast(\rho)(V_1)=0$ and
$[V_1,V_2](t,\eta) = \big((t,\eta), (0,0) \big)$ for all
$\DS (t,\eta) \in [0,\epsilon_{\VEC{u}}[ \times S^1$
according to the second and third items of Lemma~\ref{lemmaMRs2}.
...
the Lie derivative of a function along a vector field, then we
respectively get
\begin{align}
...
$\DS Q^\ast(\omega_2)(V_2) \circ \check{\phi}$ given $\eta$
fixed (i.e.\ along a geodesic), we need initial condition at $t=0$ for
$\DS Q^\ast(\omega_2)(V_2)\circ \check{\phi}$ and its
...
\end{align*}
Since
$\DS \big(Q^\ast(\omega_2)(V_2)\circ \check{\phi}\big)
\big|_{(r,\theta)=\check{\phi}^{-1}(0,\eta)} = 0$ and
$\DS \pdfdx{\Big(\big(Q^\ast(\omega_2)(V_2)\big) \circ \check{\phi}
...
$\DS \eta = e^{i\theta} \in S^1$ fixed be a geodesic on $S$ through
$\VEC{u}$, and
\item $\DS h(r) = \big(Q^\ast(\omega_2)(V_2) \circ
...
piecewise $\DS C^\infty$ curves in $S$ between
$\VEC{u}$ and $\tilde{\VEC{u}}$.
\end{theorem}

\begin{proof}
Recall that the length of a curve given by the piecewise
$\DS C^\infty$ parametric representation $\alpha:[a,b] \to S$
is given by
\[
...
$\DS (\tilde{K} \circ P)(t,\xi) = \tilde{K}(t\xi) = t\eta$
that $\DS \pdfdx{(\tilde{K} \circ P)}{t}(t,e^{i\nu})
= \pdfdx{(t e^{i\theta})}{t} = e^{i\theta} = \eta$ and
$\DS \pdfdx{(\tilde{K} \circ P)}{\nu}(t,e^{i\nu})
= \pdfdx{(t e^{i\theta})}{\nu} = 0$.  Thus
\[
...
$\DS C^\infty$ curve between $\VEC{u}$ and
$\tilde{\VEC{u}}$.  If $\beta(t) \not\in U$ for some
$a \leq t < b$, then we let $c = \inf \{ t \in [a,b] : \beta(t) \not\in U \}$.
...
$\DS g = \sigma_\eta^{-1} \circ \beta_2$.  The function is piecewise
$\DS C^\infty$.
We get
\begin{align*}
L_{\beta_2} &= \int_a^c \big\|(\beta_2)_\ast(t,1) \big\|_{\beta_2(t)} \dx{t}
...
$\DS C^\infty$ curve in $S$ between $\VEC{u}_1$ and
$\VEC{u}_2$} \big\}
\]
...
homeomorphic to $\DS \RR^2$.  In general, connected does not
imply path connected.}, there exists at list one piecewise
$\DS C^\infty$ curve between $\VEC{u}_1$ and $\VEC{u}_2$.  Therefore
...
There exist two piecewise $\DS C^\infty$ curves $\beta_1$
...
is any geodesic curve, then we have that $L_{\sigma_\eta} \leq L_{\beta}$
for all piecewise $\DS C^\infty$ curves in $S$ between $\VEC{u}_1$
...
$1\leq i \leq 2$.  If
$\DS \kappa_1 = \kappa_2 \circ G_2 \circ G_1^{-1}$
on $U_1 = G_1(D_{\epsilon})$, then $\DS G_2 \circ G_1^{-1}$ is
an isometry.
\end{theorem}

\begin{proof}
We prove that
$\DS (G_2 \circ G_1^{-1})_\ast: \TS U_1 \to \TS U_2$ is an
isometry.

We have that $\DS G_2 \circ G_1^{-1}$ maps the geodesic
$\sigma_{1,\eta}(t) = (G_1 \circ P)(t,\eta)$ onto the geodesic 
$\sigma_{2,\eta}(t) = (G_2 \circ P)(t,\eta)$ for
$0 \leq t \leq \epsilon$ and $\DS \eta \in S^1$.  As we have
...
length.  Thus $\DS G_2 \circ G_1^{-1}$ preserve the length
...
\]
for $0 \leq r < \epsilon$ and $\DS \eta \in S^1$ arbitrary.
\end{proof}
...
$\DS g = \tilde{G}_2 \circ G_1^{-1}:U_1 \to U_2$.
...
More precisely, let $\DS \omega_1^{[i]}$,
$\DS \omega_2^{[i]}$ and $\DS \rho^{[i]}$ 
...
$\DS \tilde{f}^\ast(\rho^{[2]})$ is the Riemann connection on
$S_1$ if $\DS \rho^{[2]}$ is the Riemann connection on $S_2$.
...
$\DS \tilde{f}^\ast(\rho^{[2]})$ is a connection $1$-form.
...
\]
Thus, we get that $\DS \rho^{[1]} = \tilde{f}^\ast(\rho^{[2]})$ by
...
\begin{defn}
We say that a subgroup $\DS \E_S^o$ of the group $\E_S$ is
{\bfseries transitive}\index{Transitive} on $S$ if, for
any $\VEC{u}_1,\VEC{u}_2 \in S$, there exists $\DS f \in \E_S^o$
...
Hence, we may define a map $\DS \Phi:\E_S(\VEC{u}) \to S^1$
...
$\DS \Phi:\E_S(\VEC{u}) \to S^1$ is one-to-one.
\end{prop}
...
Since $\DS f_\ast = (G \circ g_f \circ G^{-1})_\ast
...
$\DS (\phi^{-1} \circ f \circ \phi)(\VEC{w})
...
Likewise,
$\DS \diff (\phi^{-1} \circ f \circ \phi)(\VEC{w}) \VEC{y}
...
Let $S$ be an oriented $2$-dimensional Riemannian manifold.
Suppose that the map $\DS \Phi:\E_S(\VEC{u}) \to S^1$ is
...
\begin{proof}
We assume that
$\DS D_{\epsilon_{\VEC{u}}} \cong B_{\epsilon_{\VEC{u}}}(\VEC{0})
\subset \RR^2$.

Given $\VEC{v} \in G(D_\epsilon)$, let $\VEC{w} = G(\VEC{v})$.  As we
have seen in the proof of Proposition~\ref{propPhi1to1},
$\DS G^{-1} \circ f \circ G = g_f$ is a rotation in
$D_{\epsilon_{\VEC{u}}}$.  Since
$\DS \Phi:\E_S(\VEC{u}) \to S^1$ is onto, we have that
$\DS C_{\VEC{v}} = \{ G^{-1} f(\VEC{v}) = g_f(\VEC{w}) :
f \in \E_S(\VEC{u}) \}$ is a
...
Let $S$ be an oriented $2$-dimensional Riemannian manifold.
Suppose that $\DS \E_S^o$ is a subgroup of the group $\E_S$
of orientation preserving isometry of $S$.  If $\DS \E_S^o$
is transitive on $S$ and
$\DS \Phi:\E_S^o \cap \E_S(\VEC{u}) \to S^1$ is onto for
some $\VEC{u} \in S$, then $\DS \E_S^o = \E_S$.
\end{prop}

\begin{proof}
Given $f_1 \in \E_S$, we may use the transitivity of
$\DS \E_S^o$ to find $\DS f_2 \in \E_S^o$ such
that $f_2(f_1(\VEC{u})) = \VEC{u}$.  Hence
$f_2 \circ f_1 \in \E_S(\VEC{u})$.  Since $\Phi$ maps
$\DS \E_S^o \cap \E_S(\VEC{u})$ onto $\DS S^1$,
there exists $\DS f_3 \in \E_S^o \cap \E_S(\VEC{u})$ such
that $\Phi(f_3) = \Phi( f_2\circ f_1)$.
Since $\DS \Phi: \E_S(\VEC{u}) \to S^1$ is one-to-one, we
get that $f_3 = f_2 \circ f_1$.  Thus
$\DS f_1 = f_2^{-1} \circ f_3 \in \E_S^o$.
We have proved that $\DS \E_S \subset \E_S^o$.  But
$\DS \E_S^o$ is a subgroup of $\E_S$.  Therefore
$\DS \E_S^o = \E_S$.
\end{proof}
...
We consider $\DS S = \RR^2$ with the standard Euclidean
...
$\DS S = \RR^2$.  It is clearly a subgroup of the group
...
$\DS \Phi: G \cap \E_S(\VEC{0}) \to S^1$ is onto since
...
required) on $\DS \RR^2$ is equal to the Euclidean group
$E(2)$ formed of all rotations, reflections through plans containing
the origin and translation on $\DS S = \RR^2$.}.
...
We consider $\DS S = S^2$ with the Riemannian metric induced
as a submanifold of $\DS \RR^3$.  The orientation on
$\DS S^2$ is the orientation induced by the standard
outward unit normal to $\DS S^2$ at each point of
$\DS S^2$ as defined in Definition~\ref{manifNormal}.

The group $G$ of rotations in $\DS \RR^3$ centred at the origin
is a transitive group of orientation preserving isometries on
$\DS S^2$.  It therefore follows from
Proposition~\ref{propIsoGr} that $\E_S = G$.  Moreover, we get from
Proposition~\ref{propTransKconst} that the curvature $\kappa$ of
$\DS S^2$ is constant.  It follows from
Example~\ref{eggGBsphere} that
$\DS 4\pi = \int_{S^2} \kappa \dx{V} = \kappa \int_{S^2} \dx{V} 
= 4\pi \kappa$.  Thus $\kappa = 1 > 0$.

Given $\DS \VEC{u} \in S^2$, the isotropy group of
$\DS S^2$ at $\VEC{u}$ is the group of all rotations in
$\DS \RR^3$ whose axis of rotation is the line through
...
path of shortest distance between two points on $\DS S^2$.
...
the simplest example in $\DS \RR^3$.  Nevertheless, the
...
in $\DS \RR^2$ of an oriented Riemannian manifold $S$ of
constant negative curvature.  This imbedding is not an isometry.  It
has been proved that $S$ can only be realized in $\DS \RR^n$
with $n>3$.
...
$\partial D$ of
$\DS D = \{\VEC{x} \in \RR^2 : \|\VEC{x}\| < r \}$ for some $r>0$.
They are the stereographic projections limited to the lower half of
$\DS S^2$ of all the circles \footnote{A circle on
$\DS S^2$ is defined by the intersection of a sphere with
$\DS S^2$.} that intersect perpendicularly
the equator of $\DS S^2$.

The {\bfseries Poincaré metric}\index{Poincaré Metric} on
$\TS_{\VEC{u}} D$ for $\VEC{u} \in D$ is defined by
$\DS \ps{(\VEC{u},\VEC{x}_1)}{(\VEC{u},\VEC{x}_2)}_{\VEC{u}}
...
$\DS f^{-1}_{w,\theta} = f_{-w,\theta}$ exists.  Therefore
$f_{w,\theta}(\partial D)$ splits $\DS \RR^2$ into two components:
$D$ and $\DS \RR^2 \setminus \overline{D}$.  Since
$\DS f_{w,\theta}(0) = - e^{i\theta} w \in D$, we get that
...
$\DS f_{w,\theta}^{-1}$ exists implies that $f_{w,\theta}(D) = D$.
...
$\CC$ and $\DS \RR^2$ and first note that
\[
...
We use Proposition~\ref{propIsoGr} to prove that $\DS \E_D = \E_D^o$.
The group $\DS \E_0^o$ is transitive because
$f_{w,0}$ maps $w\in D$ to $0$.  Thus
$\DS f_{-w_2,0} \circ f_{w_1,0} = f^{-1}_{w_2,0} \circ f_{w_1,0}$ maps
$w_1 \in D$ to $w_2 \in D$.  Moreover
$\DS \E_D^o \cap \E_D(0) = \{ f_{0,\theta} : \theta \in [0, 2\pi[ \}$.
Hence $\DS \Phi:\E_D^o \cap \E_D(0) \to S^1$ is onto.
...
should satisfy $\DS e^{i\theta}p_2 = q_2$ to get
...
use the equation
$\DS q_2 = e^{i\theta}p_2 = \pm e^{i\theta} |q_2| p_1$ to determine
$\theta$ and thus $p_2$.
