...
that $\displaystyle R_{k_1,k_2,\ldots,k_n}^\circ \subset R_i$ because
...
$\displaystyle \LL_P(\Chi_Z h^+) = 0$ for all partitions $P$ of $R$.
...
\]
Thus $\displaystyle \LL_P(\Chi_Z h^+ ) = 0$.  The proof that
$\displaystyle \LL_P(\Chi_Z h^-) = 0$ for all partitions $P$ of $R$ is similar.
\end{proof}
...
$\displaystyle W_j \subset W_{j+1}^\circ$ for all $j$.
...
For $j \geq 2$, let $\displaystyle U_{\alpha,j} = U_\alpha \cap
...
$\displaystyle \VEC{y} \in W_{j+1}^\circ \setminus W_{j-2}$
if $q<j-2$ and $q>j+1$, it suffices to choose an open neighbourhood
$\displaystyle W_{\VEC{x}} \subset W_{j+1}^\circ \setminus W_{j-2}$ of $\VEC{x}$.
...
also get that $\displaystyle \diff g^{-1}(\VEC{y})$ exists for all
$\VEC{y} \in g(W)$.  In particular, $\displaystyle \diff g^{-1}(\VEC{y})
...
$\displaystyle (f \circ T) |\det T| : T^{-1}(h(W)) \to \RR$ is a
...
Since $\displaystyle (f \circ T) |\det T| : T^{-1}(h(W)) \to \RR$ is a Riemann
...
$\displaystyle Q_1^{-1}(R)$ is Jordan measurable because
$\displaystyle \partial Q_1^{-1}(R) = Q_1^{-1}(\partial R)$ is of
measure zero since $\partial R$ is of measure zero.  We also have that
$\displaystyle Q_1^{-1}(R)$ is bounded because $R$ is a compact set and thus
$\displaystyle Q_1^{-1}(R)$ is a compact set in $\displaystyle \RR^k$.
...
It follows as in (iii.a) that $\displaystyle Q_2^{-1}(R)$ is a bounded
...
Recall that $\displaystyle \tilde{g} = Q_2\circ Q_1 = T^{-1} \circ g$ on $U_1$.
...
radius $\displaystyle (M n^{3/2} L)/N$ in the subspace $S$ of
dimension $n-1$.  The volume of a sphere of radius $r$ in
$\displaystyle \RR^m$ is
...
\stage{$\displaystyle \mathbf{1^{st}}$ Method}
...
$\displaystyle \{ (a_1(\VEC{x}),b_1(\VEC{x}),a_2(\VEC{x}),b_2(\VEC{x}),\ldots,
a_n(\VEC{x}),b_n(\VEC{x})) : \VEC{x} \in U \} \subset \QQ^{2n}$
and a subset of a countable set is a countable set.

\stage{$\displaystyle \mathbf{2^{nd}}$ Method}
...
We have that $\displaystyle m_{i,j}(S^\circ) \leq m_{i,j}(S)$ for
...
$\displaystyle r = \sqrt{x^2+y^2} \leq z \leq 1$.  We have that
$\displaystyle
...
$\displaystyle 0 \leq z \leq 2 - \sqrt{x^2+y^2}
