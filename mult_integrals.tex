...
have $\displaystyle \sum_{i=0}^N V(R_i) < \epsilon$.}.
...
$R$, we have $\displaystyle \LL(f) = \U(f) = \int_R f$.  Hence
\[
...
\]
for $\displaystyle 0 <j,k \leq 2^i$.  For each $i>0$, we have
...
$\displaystyle \int_I \left( \int_I \chi_Q(x_1,x_2) \dx{x_2} \right)
...
We have $\displaystyle \psi_k \in C^\infty(\RR^n)$,
...
$\displaystyle Q \subset \NNp$, we have
\[
...
$\displaystyle G \subset \NNp$ such that $Q\subset G$, we have
\begin{align*}
...
$\displaystyle G\subset \NNp$ with $Q \subset G$ is arbitrary, we get
\[
...
$\displaystyle V(S_i) = n^{n/2} M^n d_i^n$.  We have
\[
...
$\displaystyle 3z^2 = x^2 + y^2$ where $z \geq 0$, we have
\[
