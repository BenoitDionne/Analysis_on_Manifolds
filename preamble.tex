...
\newcommand{\titlePage}{
  ...
  \begin{titlepage}
    \newsavebox{\glass}
    \savebox{\glass}{\includegraphics[width=7in]{images/cover_glass}}
    \newsavebox{\stairs}
    \savebox{\stairs}{\includegraphics[width=2.5in]{images/cover_stairs}}
    \begin{inctext}[paper=current, target=mytarget]
      \begin{tikzpicture}
        ...
        \node[inner sep=0pt,above right] (glass) at (0.75in,2.5in) {\usebox{\glass}};
        \fill[lime!4,path fading=south] (0.75in,4.9in) rectangle (7.80in,5.74in);
        \node[inner sep=0pt,below right] (stairs) at (0.75in,10in) {\usebox{\stairs}};
        \fill[lime!4,path fading=north] (0.75in,6.15in) rectangle (3.3in,7in);
